...
contract RewardPointData is BasicAuth, IssuerRole {
    ...
    function setBalance(address a, bytes32[] value) onlyLatestVersion public returns (bool) {
        _balances[a] = value;
        return true;
    }
    ...
    function getAccountInfo(address account) public view returns (bool, bytes32[]) {
        return (_accounts[account], _balances[account]);
    }
